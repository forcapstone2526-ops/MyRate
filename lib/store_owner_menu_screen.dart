...
import 'package:my_rate/main.dart'; // adjust if your main.dart path is different
import 'package:my_rate/store_owner_edit_profile.dart';
import 'dart:io';
                  ...
                  _buildMenuTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const StoreOwnerEditProfile(),
                        ),
                      );
                    },
                  ),
